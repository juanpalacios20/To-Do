...
const LazyPerfilModal = lazy(() => import("./PerfilModal.jsx"))
...
function NavBar() {
    ...
    return (
        <>
                ...
                <div className="NavBar transition-all duration-300">
                    <div className="NavBarContent">
                        ...
                        <div className="NavBarLogo flex flex-row flex-nowrap">
                            <h1 className="NavBarText text-8xl">TaskFill</h1>
                        ...
                        <div onClick={() => setPerfilModal(true)} className="NavBarPerfil hover:cursor-pointer p-2 Transition transition-all duration-300">
            ...
            <Suspense>
                <LazyPerfilModal state={perfilModal} toggleOff={closePerfilModal} />
            </Suspense>
            {/* ======================================= Dark Mode ======================================= */}
            <DarkMode />
        </>
